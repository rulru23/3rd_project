...
<h1 style="text-align:center">Sauce</h1>

<div class="b_box">
	<c:forEach var="sList" items="${sList}" varStatus="status">
		<div class="box" id = "${sList.sauce_id}" onclick="choice(this.id)">
			<img src="/images/sauce${status.index }.png" class="b_img1">
			${sList.sauce}
		</div>	
	</c:forEach>
</div>
...
function choice(id){
	...
	window.parent.document.getElementById("sauce_name").value = breadName;
	
	window.parent.document.getElementById("sauce").value = id;
