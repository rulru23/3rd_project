...
<h1 style="text-align:center">Vegetable</h1>
	<div class="b_box">
		<c:forEach var="vList" items="${vList}" varStatus="status">
			<div class="box" id = "${vList.veg_id}" onclick="choice(this.id)">
				<img src="/images/veg.png" class="b_img1">
				${vList.veg}
			</div>	
		</c:forEach>
	</div>
...
function choice(id){
	...
	window.parent.document.getElementById("veg_name").value = breadName;
	
	window.parent.document.getElementById("veg").value = id;
