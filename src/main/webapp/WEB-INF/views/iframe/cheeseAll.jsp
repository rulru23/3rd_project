...
<h1 style="text-align:center">Cheese</h1>
<div class="b_box">
	<c:forEach var="cList" items="${cList}" varStatus="status">
		<div class="box" id = "${cList.cheese_id}" onclick="choice(this.id)">
			<img src="/images/cheese.png" class="b_img1">
			${cList.cheese}
		</div>	
	</c:forEach>
</div>
...
function choice(id){
	...
	window.parent.document.getElementById("cheese_name").value = breadName;
	
	window.parent.document.getElementById("cheese").value = id;
